...
class FrontPageTests: XCTestCase {
    
    func testDeserialization() throws {
        struct TestCase {
            let jsonString: String
            let expected: FrontPage
        }
        let testCases = [
            TestCase(jsonString: """
        {
            "uid": "a61bd361-13fa-4f76-abb7-09cdb8be7e3f",
            "createdAt": "2022-08-01T15:20:36.000",
            "updatedAt": "2022-08-23T16:57:45.000",
            "title": "Выпуск от 01.08.2022",
            "publicationDate": "2022-08-01T15:20:55.000",
            "endDate": null,
            "content": [
                {
...
""", expected: .init(uid: "a61bd361-13fa-4f76-abb7-09cdb8be7e3f",
                     createdAt: .init(year: 2022, month: 8, day: 1, hour: 15, minute: 20, second: 36, millisecond: 000)!,
                     updatedAt: .init(year: 2022, month: 8, day: 23, hour: 16, minute: 57, second: 45, millisecond: 000)!,
                     title: "Выпуск от 01.08.2022",
                     publicationDate: .init(year: 2022, month: 8, day: 1, hour: 15, minute: 20, second: 55, millisecond: 000)!,
                     endDate: nil,
                     content: [
                        .init(uid: "0849a006-4fe3-4ba0-a587-bd4e49026436",
        ...
        for testCase in testCases {
            ...
            let postOnFrontPage = try jsonDecoder.decode(FrontPage.self, from: jsonData)
